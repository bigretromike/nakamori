...
from resources.lib import ShokoUtils
...
def play_video(parameters):
    ...
    try:
        ...
        if KodiUtils.play_video(parameters['ep_id'],
            ...
            if cmd is not None:
                if cmd == "voteSer":
                    ...
                    if str(parameters['ep_id']) != "0":
                        ...
                        KodiUtils.file_list_gui(nt.json.loads(nt.get_json(ep_url)))
                elif cmd == 'rescan':
                    ShokoUtils.rescan_file(parameters, True)
                elif cmd == 'rehash':
                    ShokoUtils.rescan_file(parameters, False)
                elif cmd == 'missing':
                    ShokoUtils.remove_missing_files()
                elif cmd == 'mediainfo':
                    ShokoUtils.mediainfo_update()
                elif cmd == 'statsupdate':
                    ShokoUtils.stats_update()
                elif cmd == 'folderlist':
                    ShokoUtils.folder_list()
